...
def plot_capacity_factors(data_sim_meas, location_name, year, legend_names, colors_CF, linestyles_CF, line_widths_CF, output_dir_timeseries, x_limit=5000):
    ...
    Parameters:
        loc_data (pd.DataFrame): DataFrame with capacity factor time series for the location.
...
def capacity_factor_formatting(
    ...
    """
    Generate legend names, colors, linestyles, and line widths for capacity factor plots.
    ...
    # ------------------------------------------------------------------------------------
    return legend_names, colors_CF, linestyles_CF, line_widths_CF
...
def highres_plot_formatting(
    ...
    # ------------------------------------------------------------------------------------
    return legend_names_high_res, colors_high_res, linestyles_high_res, line_widths_high_res
