...
database_order = ['PV-MEAS', 'RN-MERRA2', 'RN-SARAH', 'PG2-SARAH', 'PG2-SARAH2', 'PG2-ERA5', 'PG3-SARAH3', 'PG3-ERA5']
...
def sort_key(col):
    ...
    db_key = db.split('-')[1] if '-' in db else db  # This extracts "SARAH", "SARAH2", etc.
